...
class TotalFragment : Fragment() {
    ...
    override fun onAttach(context: Context) {
        ...
        if (context is OnTotalFragmentInteractionListener) {
            ...
            throw RuntimeException(context.toString() + " must implement OnTotalFragmentInteractionListener")
        }
    }
    ...
    fun setOnFragmentInteractionListener(callback: OnTotalFragmentInteractionListener) {
